...
(cl:defmethod cl:initialize-instance :after ((m <GridPlaneInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GridPlaneInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fitplane_planner-msg:<GridPlaneInfo> is deprecated: use fitplane_planner-msg:GridPlaneInfo instead.")))
...
(cl:defmethod resolution-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:resolution-val is deprecated.  Use fitplane_planner-msg:resolution instead.")
  (resolution m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:width-val is deprecated.  Use fitplane_planner-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:height-val is deprecated.  Use fitplane_planner-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'origin-val :lambda-list '(m))
(cl:defmethod origin-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:origin-val is deprecated.  Use fitplane_planner-msg:origin instead.")
  (origin m))

(cl:ensure-generic-function 'traversability-val :lambda-list '(m))
(cl:defmethod traversability-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:traversability-val is deprecated.  Use fitplane_planner-msg:traversability instead.")
  (traversability m))

(cl:ensure-generic-function 'plane_angle-val :lambda-list '(m))
(cl:defmethod plane_angle-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:plane_angle-val is deprecated.  Use fitplane_planner-msg:plane_angle instead.")
  (plane_angle m))

(cl:ensure-generic-function 'plane_height-val :lambda-list '(m))
(cl:defmethod plane_height-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:plane_height-val is deprecated.  Use fitplane_planner-msg:plane_height instead.")
  (plane_height m))

(cl:ensure-generic-function 'occupancy-val :lambda-list '(m))
(cl:defmethod occupancy-val ((m <GridPlaneInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fitplane_planner-msg:occupancy-val is deprecated.  Use fitplane_planner-msg:occupancy instead.")
  (occupancy m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GridPlaneInfo>)))
  ...
  "fitplane_planner/GridPlaneInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GridPlaneInfo)))
  "Returns string type for a message object of type 'GridPlaneInfo"
  "fitplane_planner/GridPlaneInfo")
