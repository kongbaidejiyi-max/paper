...
namespace ego_planner
{
  ...
  //     Eigen::Vector3d local_target_pt,      Eigen::Vector3d local_target_vel,  bool flag_polyInit,
  //     bool flag_randomPolyTraj)
    ...
    void updateGRPPath(const fitplane_planner::GlobalPath &msg);
    bool getLocalTargetFromGRP(const Eigen::Vector3d &current_pos, Eigen::Vector3d &local_target_pt, Eigen::Vector3d &local_target_vel) const;
  ...
  private:
    ...
    bool grp_enable_{false};
    double grp_forward_len_{15.0};
    GRPManager grp_manager_;
